...
{
    return tex.SampleLevel(sAnisoSampler, pos.xy, 0.0, off.xy);
}
...
{
    return tex.SampleGrad(sAnisoSampler, pos.xy, grad, grad);
}
...
{
    return tex.SampleLevel(sAnisoSampler, pos.xy, 0.0);
}
