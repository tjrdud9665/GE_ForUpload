...
SizeBoxSlot::SizeBoxSlot(const SizeBoxSlot& Other)
	:Super(Other)
...
void SizeBoxSlot::SetupGeometry(class Renderer* pRenderer)
{
	...
	if (Parent)
	{
		...
		contentDesiredSize = SVector2(((SizeBox*)Parent)->GetWidthOverride(), ((SizeBox*)Parent)->GetHeightOverride());
